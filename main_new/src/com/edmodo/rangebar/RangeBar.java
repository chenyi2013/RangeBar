...
public class RangeBar extends View {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		mBar = new Bar(ctx, marginLeft, yPos, barLength, mTickCount,
				mTickHeightDP, mBarWeight, mBarColor, mDensity);
		...
		new ConnectingLine(ctx, yPos, mConnectingLineWeight,
	...
	private void rangeBarInit(Context context, AttributeSet attrs) {
		...
		mSdpi = getResources().getDisplayMetrics().scaledDensity;
	...
	private void createConnectingLine() {
		...
		new ConnectingLine(getContext(), getYPos(), mConnectingLineWeight,
				mConnectingLineColor);
		invalidate();
	}
